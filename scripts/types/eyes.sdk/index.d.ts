...
export interface TestResults {
  ...
  stepsInfo: {
    ...
    appUrls: { step: string };
    apiUrls: { baselineImage: string; currentImage: string; diffImage: string };
  }[];
  steps: number;
  matches: number;
  mismatches: number;
...
export abstract class ScaleProvider {
  /**
...
export declare class ContextBasedScaleProvider extends ScaleProvider {
   ...
   */
  constructor(
    topLevelContextEntireSize: RectangleSize,
 ...
 */
export abstract class ScaleProviderFactory {
  /**
...
export declare class ContextBasedScaleProviderFactory extends ScaleProviderFactory {
  ...
  constructor(
    ...
    viewportSize: RectangleSize,
    devicePixelRatio: number,
    scaleProviderHandler: PropertyHandler<ScaleProvider>
  );
  /**
   * The implementation of getting/creating the scale provider, should be implemented by child classes.
   * @param imageToScaleWidth The width of the image to scale. This parameter CAN be by class implementing the factory, but this is not mandatory.
...
export abstract class CutProvider {
  /**
...
export abstract class EyesScreenshot {
   ...
   */
  abstract getSubScreenshot(
    region: Region,
    coordinatesType: CoordinatesType,
    throwIfClipped: boolean
  ): Promise<EyesScreenshot>;
  /**
   ...
   */
  abstract convertLocationFromLocation(
    location: Location,
   ...
   */
  abstract getLocationInScreenshot(
    location: Location,
    coordinatesType: CoordinatesType
  ): Location;
  /**
   ...
   */
  abstract getIntersectedRegion(
    region: Region,
    originalCoordinatesType: CoordinatesType,
    resultCoordinatesType: CoordinatesType
  ): Region;
  /**
...
export abstract class RegionProvider {
  ...
  getRegionInLocation(
    image: MutableImage,
    toCoordinatesType: CoordinatesType,
    promiseFactory: PromiseFactory
  ): Promise<Region>;
  /**
...
export declare class MatchWindowTask {
  ...
  constructor(
    ...
    retryTimeout: number,
    appOutputProvider: {
      appOutput: { screenShot64: string; title: string };
  ...
  matchWindow(
    userInputs: Trigger[],
    lastScreenshot: { imageBuffer: Buffer; width: number; height: number },
    regionProvider: RegionProvider,
    tag: string,
    shouldRunOnceOnRetryTimeout: boolean,
...
export declare class MutableImage {
  ...
  getImage(): MutableImage;
  getSubScreenshot(): Promise<EyesScreenshot>;
  convertLocationFromLocation(): Location;
  getLocationInScreenshot(): Location;
  getIntersectedRegion(): Region;
  convertRegionLocation(): Region;
}
...
export declare class ServerConnector {
  ...
  replaceWindow(
    runningSession: RunningSession,
    stepIndex: number,
    replaceWindowData: object,
    screenshot: Buffer
  ): Promise<object>;
}

export abstract class EyesBase {
  /**
   * @param promiseFactory An object which will be used for creating deferreds/promises.
   * @param serverUrl
   * @param isDisabled
  ...
  setDefaultMatchSettings(
    defaultMatchSettings: MatchSettings.ImageMatchSettings
  ): void;
  /**
  ...
  checkWindowBase(
    ...
    ignoreMismatch: boolean | undefined,
    retryTimeout: number | undefined,
    regionProvider: RegionProvider,
    imageMatchSettings: MatchSettings.ImageMatchSettings | undefined
  ): Promise<{ asExpected: boolean }>;
  /**
   * Replaces an actual image in the current running session.
   * @param stepIndex The zero based index of the step in which to replace the actual image.
